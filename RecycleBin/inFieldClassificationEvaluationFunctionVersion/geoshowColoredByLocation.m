function [hRoute, hMapImage] = geoshowColoredByLocation(handles,routeInfo)
...
%   - handles
%
%   The handle to the collectorGUI. We will use handles.map, i.e. the axes
...
% lonLim = get(handles,'Xlim');
% latLim = get(handles,'Ylim');
% 
% % On the road. Blue "*".
% indicesSamplesOnRoad = routeInfo.locationsRef<0;
% hRoute.onRoad = geoshow(handles, ...
...
% hRoute.inField = geoshow(handles, ...
...
% 
% set(handles,'Xlim',lonLim);
% set(handles,'Ylim',latLim);
% 

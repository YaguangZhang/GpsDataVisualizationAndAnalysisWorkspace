...
% "nearby". We use 2 parameters here to weaken the influence of the noise.
...
%
%   For combines
%       A matrix of 5x1 arrays, each array contains
%           - The start index of this harvested sequence
%
%           - The end index of this harvested sequence
%
%       Elements below will be NaN if no unloading is detected for this
%       harvested sequence.
%           - The start index to unload this harvested sequence
%
%           - The end index to finish unloading
%
%           - Unload to which vehicle
%
%   For grain carts
%       A cell of arrays/structures, each structure contains
%           - Loading info (3x1 array)
...
%
%           - Unloading info (3x1 array, these 3 elements will be NaN if no
%           unloading is detected for this harvested sequence)
%               - The start index to unload this harvested sequence
%
%               - The end index to finish unloading
%
%               - Unload to which vehicle
%
%           - Coordinates of this product sequence (a structure with fields
%           lat and lon)
%
%   For trucks
...
%               - Loading from which vehicle
%
%           - Unloading info (these 3 elements will be NaN if no unloading is detected for this
%           harvested sequence)
%               - The start index to unload this harvested sequence
%
%               - The end index to finish unloading

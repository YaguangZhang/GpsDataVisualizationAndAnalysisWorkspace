...
[ harvestedPts, boudnaryFieldShapeUtm ] = statisticalHarvestTruc( ...
    ...
    indicesFilesToUse, ...
    statesRef, boudnaryFieldShape, gridWidth );
% ----------------------------
...
save([fileName, 'extEnhFieldShape.mat'], 'extendedEnhancedFieldShape');

% % Plot the resulted field shapes on a map. hFigExtenedEnhField = figure;
% hold on; % The extended field shape.
...
% Plot the reference field boundaries on a map if they are available for
% this field.
